...
MenuButton::MenuButton(SDL_Rect position, std::string cap, short int setValue, short int *value, bool *press)
{
  // Style par défaut
...
int MenuButton::filtre(const SDL_Event *event)
{
  if(!unactive)
  {
...
void MenuButton::afficher(SDL_Surface *Screen)
{
...
void MenuButton::onFocus(bool foc, bool nextIfUnactive)
{
  int x,y;
