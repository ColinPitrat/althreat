...
Bouton::Bouton(SDL_Rect position, std::string cap, void (*cb)(void))
{
  // Style par défaut
...
int Bouton::filtre(const SDL_Event *event)
{
  if(!unactive)
  {
...
void Bouton::afficher(SDL_Surface *Screen)
{
...
void Bouton::onFocus(bool foc, bool nextIfUnactive)
{
  int x,y;
